...
ベジェ軌道をウィンドウ上で編集できるAviUtlプラグインです。
...
| :---: | :---: | :---: | :---: |
| 制御点をグラフの上下にスナップ | 制御点をグラフの上下にスナップ | ハンドルの長さを固定 | 2つの制御点を同時に動かす |

カーブエディタ内の"Value/ID"のスイッチをクリックすることで，以下で紹介する2つの編集モード「Valueモード」と「IDモード」を切り替えることができます。
...
### 保存
カーブをユーザーライブラリに保存します。ボタンと動作は同じです。
