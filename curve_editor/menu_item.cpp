...
namespace curve_editor {
	...
	void MenuItem::get_menu_item_info(MENUITEMINFOA& minfo, uint32_t id) noexcept {
		...
		minfo.dwTypeData = const_cast<LPSTR>(label_.c_str());
