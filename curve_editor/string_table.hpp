...
namespace curve_editor::global {
	...
	public:
		enum class StringId : size_t {
			...
			CaptionPreferences,
			PrefLabelLanguage,
			PrefLabelNotifyUpdate,
			PrefLabelTheme,
			PrefLabelCurveColor,
			PrefLabelCurveThickness,
			PrefLabelCurveResolution,
			PrefLabelShowBgImage,
			PrefLabelBgImagePath,
			PrefLabelBgImageOpacity,
			PrefLabelApplyButtonHeight,
			PrefLabelShowTrace,
			PrefLabelEnableAnimation,
			PrefLabelShowPopup,
			PrefLabelEnableHotkeys,
			PrefLabelInvertWheel,
			PrefLabelAutoCopy,
			PrefLabelAutoApply,
			PrefLabelWordWrap,
			NumStringId
