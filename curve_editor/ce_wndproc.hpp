...
#define CE_WD_POS_SIDE(rc)			0, 0, g_cfg.sepr - CE_SEPR_W, rc.bottom
#define CE_WD_POS_EDT(rc)			g_cfg.sepr + CE_SEPR_W, 0, MINLIM(rc.right - g_cfg.sepr - CE_SEPR_W, CE_WD_EDT_MINW), rc.bottom
