...
namespace cved {
	...
	public:
		...
		virtual mkaul::Point<double> client_to_view(const mkaul::Point<float>& point_client, const mkaul::WindowRectangle& rect_wnd) const noexcept = 0;
		...
		virtual mkaul::Point<float> view_to_client(const mkaul::Point<double>& point_view, const mkaul::WindowRectangle& rect_wnd) const noexcept = 0;
	};
}